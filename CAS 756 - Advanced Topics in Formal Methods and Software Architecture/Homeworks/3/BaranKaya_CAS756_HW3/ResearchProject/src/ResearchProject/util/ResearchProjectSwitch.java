 ...
 * @generated
 */
public class ResearchProjectSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ResearchProjectPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResearchProjectPackage.TIMED_ELEMENT: {
				TimedElement timedElement = (TimedElement)theEObject;
				T result = caseTimedElement(timedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResearchProjectPackage.PROJECT: {
				Project project = (Project)theEObject;
				T result = caseProject(project);
				if (result == null) result = caseNamedElement(project);
				if (result == null) result = caseTimedElement(project);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResearchProjectPackage.PARTNER: {
				Partner partner = (Partner)theEObject;
				T result = casePartner(partner);
				if (result == null) result = caseNamedElement(partner);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResearchProjectPackage.EFFORT: {
				Effort effort = (Effort)theEObject;
				T result = caseEffort(effort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResearchProjectPackage.WORKPACKAGE: {
				...
				if (result == null) result = caseTimedElement(workpackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResearchProjectPackage.TASK: {
				Task task = (Task)theEObject;
				T result = caseTask(task);
				if (result == null) result = caseNamedElement(task);
				if (result == null) result = caseTimedElement(task);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResearchProjectPackage.DELIVERABLE: {
				...
				if (result == null) result = caseTimedElement(deliverable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
