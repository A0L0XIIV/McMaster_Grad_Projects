...
path_A = "B:\McMaster\CAS 764 - Advance Topics in Data Management\Project\Data\\citations\\citeseer.csv"
path_B = "B:\McMaster\CAS 764 - Advance Topics in Data Management\Project\Data\\citations\\dblp.csv"
...
out_attr = ['title', 'authors', 'journal', 'month', 'year', 'publication_type']
...
C = ob.block_tables(A, B, l_overlap_attr=blocking_col,r_overlap_attr=blocking_col,rem_stop_words=use_stop_words,q_val=q_gram_value,word_level=use_world_level,overlap_size=overlap_size,allow_missing=add_missing_val,n_jobs=-1,show_progress=False)
len(C)
"""
overlap_size = 3
